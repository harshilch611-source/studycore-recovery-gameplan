...
{
  "executiveSummary": "string — 2-3 sentences: where the student is, what the gap is, what needs to happen",
...
- Domain analysis must cross-reference baseline band with HiScores/assignment accuracy. Weak baseline + still weak accuracy = Critical. Weak baseline + improving accuracy = being addressed.
...
- founderNote is confidential — do NOT appear in student-facing PDF. Use it for tutor performance concerns, guarantee liability notes, family dynamics, etc.`;
...
Generate the recovery gameplan JSON now. Be clinically honest about achievability. Flag any resource constraint that makes the target unrealistic.\`;
}
